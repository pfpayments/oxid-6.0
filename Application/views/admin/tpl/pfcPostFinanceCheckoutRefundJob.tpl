...
[{oxscript include=$oViewConf->getModuleUrl('pfcPostFinanceCheckout','out/src/js/refund.js')}]
    ...
    <tr>
        <td valign="top" align="left" width="50%" style="padding: 10px;">
            ...
            <form action="[{ $oViewConf->getSelfLink() }]" method="POST"
                  class="PostFinanceCheckout-line-item-grid " id="completion-form">
