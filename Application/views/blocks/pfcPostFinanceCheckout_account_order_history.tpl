	...
	<li>
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				[{if $order->getPostFinanceCheckoutDownloads()}]
				<strong>[{oxmultilang ident="pfc_postFinanceCheckout_Downloads"}]</strong>
				<ul class="list-unstyled">
					[{foreach from=$order->getPostFinanceCheckoutDownloads() item=pfcdownload}]
					<li><a href="[{$pfcdownload.link}]">[{$pfcdownload.text}]</a></li>
					[{/foreach}]
				</ul>
				[{/if}]
			</div>
